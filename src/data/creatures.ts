...
export const SPECIES: Record<string, Species> = {
  ...
  emberkeep: {
    ...
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'cinderBurst' },
      { level: 4, tech: 'emberWave' },
      { level: 8, tech: 'dirge' },
      { level: 12, tech: 'pyreLance' },
      { level: 16, tech: 'abyssalBolt' },
  ...
  lanternwake: {
    ...
    height: 1.6,
    hover: 0.15,
    base: { hp: 62, mp: 38, off: 15, def: 16, spd: 19, mag: 28, res: 19 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'cinderBurst' },
      { level: 4, tech: 'emberWave' },
  ...
  everember: {
    ...
    height: 1.95,
    hover: 0.25,
    base: { hp: 79, mp: 48, off: 19, def: 21, spd: 24, mag: 36, res: 24 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'cinderBurst' },
      { level: 4, tech: 'emberWave' },
    ...
    blurb: 'A flame that will never cross and never die — eternal, and therefore a little wrong.',
  },
  ashmoth: {
    id: 'ashmoth',
    name: 'Ashmoth',
    ...
    growth: ASSASSIN_GROWTH,
    learnset: [
      { level: 1, tech: 'nightSpiral' },
      { level: 4, tech: 'gloomLance' },
      { level: 8, tech: 'shadowRend' },
  ...
  cindershroud: {
    ...
    height: 1.7,
    hover: 0.3,
    base: { hp: 59, mp: 30, off: 24, def: 15, spd: 26, mag: 16, res: 14 },
    growth: ASSASSIN_GROWTH,
    learnset: [
      { level: 1, tech: 'nightSpiral' },
      { level: 4, tech: 'gloomLance' },
    ...
    blurb: 'The ash gathered into a reaper of cinders. What it sweeps up, it keeps.',
  },
  wardling: {
    id: 'wardling',
    name: 'Wardling',
  ...
  reliquary: {
    ...
    art: 'llReliquary',
    height: 1.95,
    base: { hp: 76, mp: 27, off: 22, def: 26, spd: 14, mag: 16, res: 23 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'emberFang' },
      { level: 4, tech: 'cinderBurst' },
  ...
  lanternlord: {
    ...
    art: 'llLanternlord',
    height: 2.4,
    base: { hp: 96, mp: 34, off: 28, def: 33, spd: 17, mag: 21, res: 29 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'emberFang' },
      { level: 4, tech: 'cinderBurst' },
    ...
    blurb: 'The last keeper, become the thing it kept: a lord of held light, crowned in flame that never falls.',
  },
  grievewisp: {
    id: 'grievewisp',
    name: 'Grievewisp',
  ...
  mournlight: {
    ...
    height: 1.55,
    hover: 0.4,
    base: { hp: 57, mp: 41, off: 12, def: 15, spd: 20, mag: 30, res: 20 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'gloomLance' },
      { level: 4, tech: 'hexBolt' },
    ...
    blurb: 'A whole mourning made luminous — a rose window of sorrow that will not let its light go dim.',
  },
  keptsoul: {
    id: 'keptsoul',
    name: 'Keptsoul',
  ...
  heldshade: {
    ...
    height: 2,
    hover: 0.25,
    base: { hp: 70, mp: 30, off: 20, def: 24, spd: 15, mag: 19, res: 24 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'gloomLance' },
      { level: 4, tech: 'shadowRend' },
    ...
    blurb: 'Kept so long it became its own cage. The reaching never stops; the door never opens.',
  },
  ...
  mistling: {
    ...
    height: 1.2,
    hover: 0.16,
    base: { hp: 42, mp: 24, off: 10, def: 11, spd: 14, mag: 19, res: 13 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'tidalSlap' },
      { level: 4, tech: 'mistVeil' },
  ...
  cindermage: {
    ...
    height: 1.25,
    hover: 0.12,
    base: { hp: 40, mp: 26, off: 11, def: 10, spd: 13, mag: 21, res: 12 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'cinderBurst' },
      { level: 4, tech: 'emberWave' },
  ...
  sigilwarden: {
    ...
    height: 2.2,
    hover: 0.3,
    base: { hp: 72, mp: 34, off: 14, def: 15, spd: 12, mag: 24, res: 18 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'gloomLance' },
      { level: 4, tech: 'hexBolt' },
  ...
  shieldshard: {
    ...
    art: 'ccShieldshard',
    height: 1.6,
    base: { hp: 58, mp: 18, off: 17, def: 20, spd: 11, mag: 11, res: 17 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'quakeCore' },
      { level: 4, tech: 'ironHowl' },
      { level: 8, tech: 'rendingStrike' },
      { level: 12, tech: 'boltPierce' },
      { level: 16, tech: 'overload' },
      { level: 20, tech: 'railvolt' },
    ],
  ...
  geomote: {
    ...
    art: 'ccGeomote',
    height: 1.4,
    base: { hp: 60, mp: 18, off: 15, def: 21, spd: 10, mag: 12, res: 18 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'seedVolley' },
      { level: 4, tech: 'bloomPulse' },
  ...
  prismguard: {
    ...
    art: 'ccPrismguard',
    height: 1.7,
    base: { hp: 56, mp: 20, off: 16, def: 19, spd: 12, mag: 14, res: 19 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'frostLance' },
  ...
  vaultwarden: {
    ...
    art: 'ccVaultwarden',
    height: 2.4,
    base: { hp: 86, mp: 24, off: 18, def: 24, spd: 11, mag: 14, res: 22 },
    growth: HERO_GROWTH,
    learnset: [
      { level: 1, tech: 'frostLance' },
      { level: 4, tech: 'rendingStrike' },
      { level: 8, tech: 'glacierSpire' },
      { level: 12, tech: 'quakeCore' },
      { level: 16, tech: 'overload' },
      { level: 20, tech: 'maelstrom' },
  ...
  hexshade: {
    ...
    height: 1.7,
    hover: 0.3,
    base: { hp: 46, mp: 30, off: 10, def: 12, spd: 14, mag: 22, res: 16 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'gloomLance' },
      { level: 4, tech: 'hexBolt' },
  ...
  palefire: {
    ...
    height: 1.3,
    hover: 0.4,
    base: { hp: 44, mp: 28, off: 11, def: 11, spd: 13, mag: 21, res: 14 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'cinderBurst' },
      { level: 4, tech: 'emberWave' },
  ...
  direwisp: {
    ...
    height: 1.5,
    hover: 0.4,
    base: { hp: 45, mp: 30, off: 9, def: 12, spd: 15, mag: 22, res: 16 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'frostLance' },
      { level: 4, tech: 'mistVeil' },
      { level: 8, tech: 'tidalSlap' },
      { level: 12, tech: 'prismStorm' },
      { level: 16, tech: 'glacierSpire' },
      { level: 20, tech: 'renewingTide' },
    ],
  ...
  nullmancer: {
    ...
    height: 1.8,
    hover: 0.3,
    base: { hp: 48, mp: 32, off: 10, def: 13, spd: 13, mag: 23, res: 17 },
    growth: MAGE_GROWTH,
    learnset: [
      { level: 1, tech: 'hexBolt' },
      { level: 4, tech: 'gloomLance' },
