...
export const CREATURES: Record<string, PixelArt> = {
  ...
  // Impish bat rookie (Nightnip). Reimagined via PixelLab, snapped back to the
  // canonical 5-colour palette and hand-fitted to the sprite grid.
  bat: {
    palette: { k: '#1a1024', W: '#3c2b5c', d: '#6b4d9e', e: '#ffd166' },
    rows: [
      '........................',
      '........................',
      '................k.......',
